...
* Cоздайте .env файл и впишите:
    ...
    ```
### Создать и активировать виртуальное акружение:
```
python -m venv venv
...
```
### Создать таблицы контестов и задач:
* Cкрипт работает в цикле и проверяет codeforces на наличие новых задач:
```
python codeforces_task_parser.py
```
### Запустить бота:
* Cкрипт работает в цикле и возвращает данные из БД на запросы пользователей:
```
python bot.py
```
### Не забудьте написать своему боту в лс:
```
